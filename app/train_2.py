...
def train(args):
    ...
    # input_name=["input_thesis.txt", "input_CR_prccd.txt","input_Sub_prccd.txt","input_MPQA_prccd.txt","inputPCQM_prccd.txt","input_flood_phi_prccd.txt","input_flood_colorado_prccd.txt","input_flood_qeen_prccd.txt","input_flood_manila_prccd.txt","input_fire_australia_prccd.txt","input_earthquake_chile_prccd.txt"]
    # label_name=["label_thesis.txt", "label_CR.txt","label_input_Sub.txt","label_MPQA.txt","labelPCQM.txt","label_flood_phi.txt","label_flood_colorado.txt","label_flood_qeen.txt","label_flood_manila.txt","label_fire_australia.txt","label_earthquake_chile.txt"]
    input_name = ["input_PCQA.txt"]
    label_name = ["label_PCQA.txt"]

    with open("30JanMulti_PCQA_Train2_CV50_W2V_Glove_cnn3xStatic.txt",'wb') as result_CV:
