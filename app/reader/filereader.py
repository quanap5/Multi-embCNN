...
def read_input_data(input_data_path, input_ ='', label_=''):
    ...
    texts = list(open(os.path.join(input_data_path, "input_flood_manila_prccd.txt"), "r").readlines())

    with open(os.path.join(input_data_path, "label_flood_manila.txt"), 'r') as label_f:
        largest_label_id = 0
        for line in label_f:
    ...
    textsPCQ = list(open(os.path.join(input_data_path, input_), "r").readlines())

    with open(os.path.join(input_data_path, label_), 'r') as label_fPCQ:
    ...
    textsVali = list(open(os.path.join(input_data_path, "input_flood_manila_prccd.txt"), "r").readlines())

    with open(os.path.join(input_data_path, "label_flood_manila.txt"), 'r') as label_fVali:
